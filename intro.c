...
int intro_draw(){
	...
	draw_text(32-((intro_count1*4)), 28, "hidden", intro_count1, intro_font, GUI_TEXT_COLOR_DEFAULT);
	draw_text(40, 28, "star", intro_count2, intro_font, GUI_TEXT_COLOR_DEFAULT);
	if(intro_count3<=5){
